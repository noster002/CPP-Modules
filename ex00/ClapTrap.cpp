...
/*   Updated: 2022/05/01 23:35:19 by nosterme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ClapTrap::beRepaired( unsigned int amount )
{
	...
	{
		if ( this->getHp() >= 10 )
			std::cout << "ClapTrap " << this->getName() << " upgraded " \
						<< amount << " hit points!" << std::endl;
		else
			std::cout << "ClapTrap " << this->getName() << " repaired " \
						<< 10 - this->getHp() << " hit points! ClapTrap " 
						<< this->getName() << " upgraded " \
						<< amount - ( 10 - this->getHp() ) \
						<< " hit points!" << std::endl;
	}
	else
		std::cout << "ClapTrap " << this->getName() << " repaired " \
